...
import PhoneSignupModal from '@/components/ui/PhoneSignupModal';
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="max-w-xl w-full rounded overflow-hidden shadow-lg py-2 px-4">
                        ...
                        <SignUpModal
                            ...
                            setShowEmailRegistration={setshowRegistration}
                            setPhoneRegistrationOpen={setShowPhoneRegistration}
                        />
                        <PhoneSignupModal
                            open={showPhoneRegistration}
                            setPhoneRegistrationOpen={setShowPhoneRegistration}
                            setShowEmailRegistration={setshowRegistration}
                        />
                    </div>
